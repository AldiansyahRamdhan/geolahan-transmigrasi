...
@section('content')
    <div class="container py-4">
        <div class="col-lg-5 mx-auto">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title mb-4">Edit Data Tanah</h5>
                    ...
                    <form action="{{ route('rekomendasi.update', $rekomendasi->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="penggunaan" name="penggunaan"
                                value="{{ old('penggunaan', $rekomendasi->penggunaan) }}" required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="rekomendasi_tanaman" name="rekomendasi_tanaman"
                                value="{{ old('rekomendasi_tanaman', $rekomendasi->rekomendasi_tanaman) }}" required>
                        </div>
